...
export const portraitImages: GalleryImage[] = [
  ...
  {
    id: 'portrait-2',
    src: 'https://res.cloudinary.com/dq0ogehwz/image/upload/c_fill,g_face,w_800,h_1000,q_auto,f_auto/v1754611195/DSC03612_pymyon.jpg',
...
export const demoReelVideos: VideoItem[] = [
  {
    ...
    videoUrl: 'https://res.cloudinary.com/dq0ogehwz/video/upload/v1768191544/DEMO_MIKEVAZQUE_2025_WEB_gqervm.mp4'
  },
  {
    id: 'video-2',
